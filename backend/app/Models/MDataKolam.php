...
class MDataKolam extends Model
{
    ...
    function viewData()
    {
        $query = $this->select("id AS id_kolam", "kode AS kode_kolam", "jenis AS jenis_kolam", "jumlah AS jumlah_kolam",  "tanggal AS tanggal_kolam")->from($this->table)->orderBy("id");
    ...
    {
        $query = $this->select("id AS id_kolam", "kode AS kode_kolam", "jenis AS jenis_kolam", "jumlah AS jumlah_kolam",  "tanggal AS tanggal_kolam")->from($this->table)
    ...
    {
        $query = $this->select("id AS id_kolam", "kode AS kode_kolam", "jenis AS jenis_kolam", "jumlah AS jumlah_kolam",  "tanggal AS tanggal_kolam")->from($this->table)->whereRaw("TO_BASE64(kode) = '$kode'");
